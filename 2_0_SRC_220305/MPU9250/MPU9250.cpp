...
float gyroBias[3] = {-1.130, -0.435, -0.336}, accelBias[3] = {-0.024, -0.001, -0.041}; // Bias corrections for gyro and accelerometer
...
void MPU9250::get_data(){
    ...
    // pitch_p=(0.996*GyY)+(1-0.996)*AcY;
        ...
        // pitch2 = -asin(2.0f * (qq[1] * qq[3] - qq[0] * qq[2]));
        // roll2  = atan2(2.0f * (qq[0] * qq[1] + qq[2] * qq[3]), qq[0] * qq[0] - qq[1] * qq[1] - qq[2] * qq[2] + qq[3] * qq[3]);
        // pitch2 *= 180.0f / PI;
        // yaw2   *= 180.0f / PI; 
        // roll2  *= 180.0f / PI;
