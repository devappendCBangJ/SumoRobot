...
int turn_escape_time = 10000000;
int back_escape_time = 10000000;
        ...
        if(All_move == true){
            ...
            // 중간 동작 : 상대 탐색 + 원 회전 + 공격
                ...
                if(ras_data[2] == 0){ // 상대방이 빨간색 끝좌표 안쪽에 위치
                    ...
                    if(ang <= angML){ // 서보 왼쪽
                        if(ras_data[1] == 1 || ras_data[1] == 2 || ras_data[1] == 3 || ras_data[1] == 4 || ras_data[1] == 9){ // 화면 원통 작음 or 보통 or 큼 or 매우 큼 or 안보임
